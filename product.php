            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <!-- 商品照片/start -->
                        <div class="col-md-6">
                            <img src="images/product/eva_1.jpg" alt="LTG-BY-0001" class="img-fluid w-100">
                        </div>
                        <!-- 商品照片/end -->
                        <!-- 商品介紹/start -->
                        <div class="col-md-6">
                            <h4 class="mb-3 title-color">LTG-BY-0001</h4>
                            ...
                            <p class="mt-4">專利樣式雙色登山拐杖握把，EVA 發泡材質</p>
                            ...
                            <p class="d-block text-secondary">產品分類：<span>握把、發泡</span></p>
                        </div>
                        <!-- 商品介紹/end -->
                        <!-- 詳細資料/start -->
                        <div class="mt-5 mb-5">
                            <ul class="nav nav-tabs" id="ProductTab">
                                <li class="nav-item">
                                    <a href="#description" class="nav-link active" data-bs-toggle="tab">描述</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#specification" class="nav-link" data-bs-toggle="tab">產品規格</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="ProductTabContnet">
                                <div class="tab-pane fade show active" id="description">
                                    <p class="p-2">專利樣式雙色EVA 發泡套管</p>
                                </div>
                                <div class="tab-pane fade" id="specification">
                                    <p class="p-2">16mm/18mm</p>
                                </div>
                            </div>
                        </div>
                        <!-- 詳細資料/end -->
                        ...
                        <div class="mb-5">
                            ...
                            <div class="d-block sidebar-product-list">
                                ...
                                <a href="product.html" class="d-inline-block">
                                    ...
                                    <h6 class="d-inline-block">TG-BY-0001</h6>
                                </a>
