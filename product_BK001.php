            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <!-- 商品照片/start -->
                        <div class="col-md-6">
                            <img src="images/product/choco85_01.png" alt="LTG-BY-0001" class="img-fluid w-100">
                        </div>
                        <!-- 商品照片/end -->
                        <!-- 商品介紹/start -->
                        <div class="col-md-6">
                            <h4 class="mb-3 title-color">CHO-BK-0001</h4>
                            ...
                            <p class="mt-4">含有43%可可含量，精緻苦味帶出可可原始風味及濃郁的可可香氣，讓此商品在60年前一上市就深受消費者喜愛直到今日。</p>
                            ...
                            <p class="d-block text-secondary">產品分類：<span>黑巧克力</span></p>
                        </div>
                        <!-- 商品介紹/end -->
                        <!-- 詳細資料/start -->
                        <div class="mt-5 mb-5">
                            ...
                            <div class="tab-content" id="ProductTabContnet">
                                <div class="tab-pane fade show active" id="description">
                                    <p class="p-2">砂糖、可可塊、植物油(棕櫚油、牛油樹油、伊利伯脂、娑羅雙樹脂、葵花籽油)、全脂奶粉、大豆卵磷脂、可可脂、香料</p>
                                </div>
