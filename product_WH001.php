            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <!-- 商品照片/start -->
                        <div class="col-md-6">
                            <img src="images/product/chocoWH_01.png" alt="LTG-BY-0001" class="img-fluid w-100">
                        </div>
                        <!-- 商品照片/end -->
                        <!-- 商品介紹/start -->
                        <div class="col-md-6">
                            <h4 class="mb-3 title-color">CHO-WH-0001</h4>
                            ...
                            <p class="mt-4">可可脂帶有些微香氣，而另外添加的牛奶固質與其它成分也會為白巧克力增添風味。</p>
                        ...
                        <div class="mt-5 mb-5">
                            ...
                            <div class="tab-content" id="ProductTabContnet">
                                <div class="tab-pane fade show active" id="description">
                                    <p class="p-2">植物油(棕櫚油、棕櫚仁油、菜籽油、乳化劑(脂肪酸甘油酯、脂肪酸山梨醇酐酯、脂肪酸丙二醇酯))、麵粉、蔗糖、奶粉、杏仁、米、乳糖、乳清粉、椰子粉、食鹽、香料、大豆卵磷脂、可可脂、抗氧化劑(混合濃縮生育醇))</p>
                                </div>
